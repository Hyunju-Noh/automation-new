    ...
    try:
        ...
        for browser_type in [playwright.chromium, playwright.firefox, playwright.webkit]:
            ...
            if menu_wrap:
                ...
                # 내부에 있는 MenuItemWrap 및 DisplayControl 클래스 찾기
                menu_item_wraps = menu_wrap.query_selector_all('div.Menustyles__MenuItemWrapCommon-cHqrwY.Menustyles__Parent-XgDRT.guwEGh.etuPlp')
