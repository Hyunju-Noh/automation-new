...
class Test_ResourceBoard:
    ...
    #리소스보드 테스트하는데 프로젝트 테스트 스크립트가 왜 실행되지?
    ...
    def process_case_2(resource_board_page):
        ...
        filtered_widgets = [
            widget for widget in resource_board_page.get_widgets()  
            if widget["widget_name"] == "Server" and widget["element_name"]
        ]
    ...
    def process_case_5(resource_board_page):
    ...
    def process_case_6(resource_board_page):
    ...
    def process_case_7(resource_board_page):
    ...
    def process_case_8(resource_board_page):
    ...
    def process_case_9(resource_board_page):
    ...
    def process_case_11(resource_board_page):
    ...
    def process_case_12(resource_board_page):
    ...
    def process_case_13(resource_board_page):
    ...
    def process_case_14(resource_board_page):
    ...
    def process_case_15(resource_board_page):
    ...
    def process_case_16(resource_board_page):
    ...
    def process_case_17(resource_board_page):
    ...
    def process_case_18(resource_board_page):
    ...
    def process_case_19(resource_board_page):
    ...
    def process_case_20(resource_board_page):
    ...
    def process_case_21(resource_board_page):
    ...
    def process_case_22(resource_board_page):
    ...
    def process_case_23(resource_board_page):
    ...
    def process_case_24(resource_board_page):
    ...
    def process_case_25(resource_board_page):
    ...
    def process_case_26(resource_board_page):
    ...
    def process_case_27(resource_board_page):
    ...
    def process_case_33(resource_board_page):
    ...
    def process_case_35(resource_board_page):
    ...
    def process_case_36(resource_board_page):
    ...
    def process_case_37(resource_board_page):
    ...
    def process_case_38(resource_board_page):
    ...
    def process_case_39(resource_board_page):
    ...
    def process_case_40(resource_board_page):
    ...
    def process_case_41(resource_board_page):
    ...
    def process_case_42(resource_board_page):
    ...
    def teardown_class(self):
        """모든 테스트 실행 후 실패 항목 보고"""
        if self.failures:
            logging.info("전체 테스트 실패 항목:")
            for failure in self.failures:
                logging.error(failure)
            failures_utils.report(self.failures)
